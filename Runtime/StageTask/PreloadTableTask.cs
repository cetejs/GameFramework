...
{
    public class PreloadTableTask : IStageTask
    {
        ...
        public string TaskInfo
        {
            get
            {
                ...
                return StringUtils.Concat("PreloadTable ", taskInfo);
            }
        }

        public PreloadTableTask(Type tableType, string overrideInfo = null)
        {
        ...
        public PreloadTableTask(List<Type> tableTypes, string overrideInfo = null)
        {
            this.overrideInfo = overrideInfo;
        ...
        public IEnumerator Run()
        {
            for (currentIndex = 0; currentIndex < tableTypes.Count; currentIndex++)
            {
                ...
                DataTableManager.Instance.PreloadTable(tableType, () =>
                {
                    completed = true;
                });
