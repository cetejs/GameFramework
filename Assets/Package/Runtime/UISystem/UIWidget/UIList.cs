...
namespace GameFramework.UIService
{
    ...
    public class UIList : MonoBehaviour
    {
        ...
        [SerializeField]
        private PoolObjectReference cellReference;
        ...
        private void Start()
        {
            if (pool == null && cellReference.RuntimeKeyIsValid())
            {
                ObjectPool objPool = Global.GetService<ObjectPoolManager>().GetObjectPool(cellReference);
        ...
        public void Init(UICell cell)
        {
            ...
            pool = new ObjectPool<UICell>("UICell");
            pool.Init(transform, cell);
            if (cellSize == Vector2.zero)
            {
