...
namespace GameFramework.Generic
{
    ...
    {
        private readonly CacheLinkedList<TValue> linkedList;
        private readonly Dictionary<TKey, LinkedListRange<TValue>> dictionary;

        public MultiDictionary(int capacity = 4)
        {
            linkedList = new CacheLinkedList<TValue>();
